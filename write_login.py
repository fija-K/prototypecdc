...
login_content = """import React, { useState, useEffect, useRef } from 'react';
...
with open('src/components/screens/LoginPage.tsx', 'w', encoding='utf-8') as f:
    f.write(login_content)

print("LoginPage written cleanly!")
